// Implemented by John Process
// Adapted by Github user deeemmell - https://github.com/deeemmell
// https://gist.github.com/nowl/828013

#include <modules/math.h>

static int SEED = 1986;
...
void pglPerlinSeed(int seed){
  SEED = seed;
}

double pglPerlin2d(double x, double y, double freq, int depth)
{
    double  xa = x*freq;
    double  ya = y*freq;
    double  amp = 1.0;
