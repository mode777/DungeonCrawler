...
Module['FS_createPath']('/assets', 'scene', true, true);
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 207, "filename": "/shaders/3d.fragment.glsl"}, {"start": 207, "audio": 0, "end": 464, "filename": "/shaders/3d.vertex.glsl"}, {"start": 464, "audio": 0, "end": 1923, "filename": "/scripts/geometry.wren"}, {"start": 1923, "audio": 0, "end": 6050, "filename": "/scripts/gltf.wren"}, {"start": 6050, "audio": 0, "end": 31567, "filename": "/scripts/gltf.wren.inc"}, {"start": 31567, "audio": 0, "end": 32717, "filename": "/scripts/json.wren"}, {"start": 32717, "audio": 0, "end": 38343, "filename": "/scripts/pgl.wren"}, {"start": 38343, "audio": 0, "end": 178875, "filename": "/assets/test.png"}, {"start": 178875, "audio": 0, "end": 21360699, "filename": "/assets/western_tiles_bake.glb"}, {"start": 21360699, "audio": 0, "end": 21402613, "filename": "/assets/blocks/ao.png"}, {"start": 21402613, "audio": 0, "end": 21404361, "filename": "/assets/blocks/stone1.bin"}, {"start": 21404361, "audio": 0, "end": 21408710, "filename": "/assets/blocks/stone1.gltf"}, {"start": 21408710, "audio": 0, "end": 21485313, "filename": "/assets/blocks/Untitled.png"}, {"start": 21485313, "audio": 0, "end": 21564626, "filename": "/assets/desert/lightmap.png"}, {"start": 21564626, "audio": 0, "end": 21629562, "filename": "/assets/desert/scene2.bin"}, {"start": 21629562, "audio": 0, "end": 21635117, "filename": "/assets/desert/scene2.gltf"}, {"start": 21635117, "audio": 0, "end": 21786221, "filename": "/assets/game/bake.bin"}, {"start": 21786221, "audio": 0, "end": 21791207, "filename": "/assets/game/bake.gltf"}, {"start": 21791207, "audio": 0, "end": 22947063, "filename": "/assets/game/bake.gltf.glb"}, {"start": 22947063, "audio": 0, "end": 23944093, "filename": "/assets/game/lightmap.png"}, {"start": 23944093, "audio": 0, "end": 23945849, "filename": "/assets/game/scene.bin"}, {"start": 23945849, "audio": 0, "end": 23953893, "filename": "/assets/game/scene.gltf"}, {"start": 23953893, "audio": 0, "end": 27118969, "filename": "/assets/game/texture.png"}, {"start": 27118969, "audio": 0, "end": 53611636, "filename": "/assets/game/texture.xcf"}, {"start": 53611636, "audio": 0, "end": 53639871, "filename": "/assets/game/Untitled.png"}, {"start": 53639871, "audio": 0, "end": 56870047, "filename": "/assets/scene/lightmap.png"}, {"start": 56870047, "audio": 0, "end": 57680239, "filename": "/assets/scene/western_tiles_bake.bin"}, {"start": 57680239, "audio": 0, "end": 57683469, "filename": "/assets/scene/western_tiles_bake.gltf"}, {"start": 57683469, "audio": 0, "end": 57685014, "filename": "/main.wren"}], "remote_package_size": 57685014, "package_uuid": "9dea7d1b-485b-444f-863c-c20fd51bc498"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 91648,
    DYNAMIC_BASE = 5334528,
    DYNAMICTOP_PTR = 91488;
...
var ASM_CONSTS = {
  56708: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 58163: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 59152: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 59245: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 60470: function() {return screen.width;},  
 60497: function() {return screen.height;},  
 60570: function($0) {if (typeof Module['setWindowTitle'] !== 'undefined') { Module['setWindowTitle'](UTF8ToString($0)); } return 0;},  
 60724: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 60890: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 61116: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 61599: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
 61669: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.silenceTimer = setTimeout(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); }},  
 63321: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vi', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']);},  
